      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 py-16 md:py-20 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        >
          ...
          <motion.div variants={FADE_UP} className="mt-2 flex flex-wrap gap-3">
            <a
              href="#cta"
              className="group inline-flex items-center gap-2 rounded-full bg-dl-orange px-6 py-3 font-inter font-semibold text-dl-deep transition-all hover:bg-dl-peach hover:shadow-[0_0_32px_rgba(230,210,168,0.4)]"
            >
              Start a Project
              <ArrowRight
                size={18}
