...
const INACTIVE_NODE = {
  ...
  borderColor: "rgba(7, 80, 118, 0.4)",
  color: "#FE7F2D",
  boxShadow: "0 0 0 rgba(255,91,4,0)",
};
const ACTIVE_NODE = {
  backgroundColor: "rgb(255, 91, 4)",
  borderColor: "rgb(255, 91, 4)",
  color: "rgb(22, 35, 42)",
  boxShadow: "0 0 18px rgba(255,91,4,0.55)",
};
