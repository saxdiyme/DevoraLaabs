...
const INACTIVE_NODE = {
  backgroundColor: "rgb(28, 51, 40)",
  borderColor: "rgba(44, 74, 58, 0.4)",
  color: "#A57333",
  boxShadow: "0 0 0 rgba(201,162,74,0)",
};
const ACTIVE_NODE = {
  backgroundColor: "rgb(201, 162, 74)",
  borderColor: "rgb(201, 162, 74)",
  color: "rgb(15, 27, 22)",
  boxShadow: "0 0 18px rgba(201,162,74,0.55)",
};
