...
function ServiceCard({ title, description, Icon, badges }: Service) {
  return (
    <motion.article
      ...
      whileHover={{ y: -4 }}
      className="group relative flex flex-col gap-5 overflow-hidden rounded-2xl border border-dl-navy/30 bg-glass p-6 transition-all duration-300 hover:border-dl-orange/60 hover:shadow-[0_0_28px_rgba(255,91,4,0.18)]"
    >
      <span
        aria-hidden
