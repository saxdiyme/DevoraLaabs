  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none relative h-32 w-32 rounded-full bg-brand-gradient shadow-[0_0_80px_rgba(255,91,4,0.5)] md:h-40 md:w-40"
        >
        ...
        {PLATFORMS.map((p, i) => {
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                <div
                  className={`flex h-9 w-9 items-center justify-center rounded-full border-2 transition-all duration-300 ${
                    isActive
                      ? "scale-125 border-dl-orange bg-dl-orange text-dl-deep shadow-[0_0_18px_rgba(255,91,4,0.6)]"
                      : isRelated
              ...
              {isActive && (
                <div className="absolute left-1/2 top-14 z-50 w-56 -translate-x-1/2 rounded-xl border border-dl-orange/40 bg-dl-deep/95 p-4 shadow-[0_0_30px_rgba(255,91,4,0.25)] backdrop-blur-md">
